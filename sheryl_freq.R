...
sheryl_txt <- analyzer('./원문/sherylsandberg.txt')
grep("_VV$", sheryl_txt, value=T)
grep("_V[^V]", sheryl_txt, value=T)
grep("_V[^BH]", sheryl_txt, value=T)
# 필요한 품사만 grep
...
filtered_tagged <- grep("_N|_V[^BH]|_JJ|_RB", sheryl_txt, value=T)
